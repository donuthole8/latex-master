\chapter{実験}
  ...
  \section{実験結果}
    ...
    \subsection*{土砂領域マスク画像作成}
      \ref{実験結果}節のオルソ画像の領域分割結果及び傾斜角度モデルを入力とし，土砂領域マスク画像作成を行った．実験1-3におけるヒストグラム均一化，土砂候補領域検出，植生領域検出，急傾斜領域検出，土砂領域検出，土砂領域マスク画像作成の各処理結果を\fref{土砂領域マスク画像作成結果（実験1）}から\fref{土砂領域マスク画像作成結果（実験3）}に示す．なお，各検出結果の赤色の領域が土砂候補領域及び土砂領域，緑色の領域が植生領域，黒色の領域が急傾斜領域であり，土砂領域マスク画像の白色の領域が土砂領域である．
