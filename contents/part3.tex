\chapter{実験}
  ...
  \section{入力データ}
    ...
    \begin{figure}[t]
      \begin{minipage}[c]{0.329\hsize}
        \centering
        \includegraphics[width=4.5cm]{image/inputs/input2-1.jpg}
        \subcaption{入力画像例1}
      \end{minipage}
      \begin{minipage}[c]{0.329\hsize}
        \centering
        \includegraphics[width=4.5cm]{image/inputs/input2-2.jpg}
        \subcaption{入力画像例2}
      \end{minipage}
      \begin{minipage}[c]{0.329\hsize}
        \centering
        \includegraphics[width=4.5cm]{image/inputs/input2-3.jpg}
        \subcaption{入力画像例3}
      \end{minipage}
    ...
    \begin{figure}[t]
      \begin{minipage}[c]{0.329\hsize}
        \centering
        \includegraphics[width=4.5cm]{image/inputs/input3-1.jpeg}
        \subcaption{入力画像例1}
      \end{minipage}
      \begin{minipage}[c]{0.329\hsize}
        \centering
        \includegraphics[width=4.5cm]{image/inputs/input3-2.jpeg}
        \subcaption{入力画像例2}
      \end{minipage}
      \begin{minipage}[c]{0.329\hsize}
        \centering
        \includegraphics[width=4.5cm]{image/inputs/input3-3.jpeg}
        \subcaption{入力画像例3}
      \end{minipage}
    ...
    \begin{figure}[t]
      \begin{minipage}[c]{0.45\hsize}
        \centering
        \includegraphics[width=\linewidth]{image/inputs/dem1.png}
        \subcaption{災害前DEM}
      \end{minipage}
      \begin{minipage}[c]{0.45\hsize}
        \centering
  ...
  \section{実験結果}
    ...
    \subsection{災害後オルソ画像の前処理}
      \label{災害後オルソ画像の前処理}
      \ref{三次元復元}項のオルソ画像と\ref{入力データ（実験）}の建物ポリゴンを入力とし，災害後オルソ画像の前処理を行った．実験1-3におけるオルソ画像の領域分割結果，カラーラベリングのラベル画像，建物領域検出の各処理結果を\fref{災害後オルソ画像の前処理（実験1）}から\fref{災害後オルソ画像の前処理結果（実験3）}に示す．
