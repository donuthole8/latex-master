    ...
    \subsection*{災害後DSMの前処理}
      ...
      \begin{figure}[tbp]
        \begin{tabular}{cc}
          \begin{minipage}[c]{0.45\hsize}
            \centering
            \includegraphics[width=6cm]{image/exmaple/geo_dsm.png}
            \subcaption{DSMのジオリファレンサ結果}
          \end{minipage} &
          \begin{minipage}[c]{0.45\hsize}
            \centering 
            \includegraphics[width=6cm]{image/exmaple/geo_ortho.png}
            \subcaption{オルソ画像のジオリファレンサ結果}
          \end{minipage} \\
          \begin{minipage}[c]{0.45\hsize}
            \centering
            \includegraphics[width=6cm]{image/exmaple/removed_building.png}
            \subcaption{建物領域の標高値補正結果}
          \end{minipage} &
          \begin{minipage}[c]{0.45\hsize}
            \centering
            \includegraphics[width=6cm]{image/exmaple/normed_dsm.png}
    ...
    \subsection*{土砂領域マスク画像作成}
      ...
      \begin{figure}[tbp]
        \begin{tabular}{ccc}
          \begin{minipage}[c]{0.329\hsize}
            \centering
            \includegraphics[width=4.5cm]{image/exmaple/clahe.png}
          ...
          \begin{minipage}[c]{0.329\hsize}
            \centering
            \includegraphics[width=4.5cm]{image/exmaple/slope_mask.png}
          ...
          \begin{minipage}[c]{0.329\hsize}
            \centering
            \includegraphics[width=4.5cm]{image/exmaple/normed_mask.png}
  ...
  \section{考察}
    ...
    \subsection*{建物領域検出・建物領域の標高値補正}
      ...
      \begin{figure}[tbp]
        \begin{minipage}[c]{0.45\hsize}
          \centering
          \includegraphics[width=\linewidth]{image/consideration/building.png}
          \subcaption{建物領域検出結果}
        \end{minipage}
        \begin{minipage}[c]{0.45\hsize}
          \centering
          \includegraphics[width=\linewidth]{image/consideration/normed_dsm.png}
          \subcaption{建物領域の標高値補正結果}
        \end{minipage}
    ...
    \subsection*{土砂マスク画像作成}
      ...
      \begin{figure}[tbp]
        \begin{minipage}[c]{0.45\hsize}
          \centering
          \includegraphics[width=3cm]{image/consideration/shadow.png}
          \subcaption{土砂中の影領域}
        \end{minipage}
        \begin{minipage}[c]{0.45\hsize}
          \centering
          \includegraphics[width=3cm]{image/consideration/sediment_shadow.png}
          \subcaption{土砂領域検出結果}
        \end{minipage}
      ...
      \begin{figure}[tbp]
        \begin{minipage}[c]{0.45\hsize}
          \centering
          \includegraphics[width=3cm]{image/consideration/road.png}
          \subcaption{無被害の道路領域}
        \end{minipage}
        \begin{minipage}[c]{0.45\hsize}
          \centering
          \includegraphics[width=3cm]{image/consideration/sediment_road.png}
          \subcaption{土砂領域検出結果}
        \end{minipage}
