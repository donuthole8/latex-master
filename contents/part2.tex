\chapter{手法}
  ...
  \section{災害前DEMの前処理}
    ...
    \subsection{リサンプリング}
      ...
      \begin{figure}[t]
        \centering
        \includegraphics[width=9cm]{image/method/mesh.png}
        \caption{リサンプリング結果}
        \label{リサンプリング結果}
      \end{figure}
